...
$responseTicker = curl_call('https://api.coinpara.com/v1/ticker');
print_r($responseTicker);

echo '<hr />';

$responseTransactions = curl_call('https://api.coinpara.com/v1/transactions?Pair=BTCTRY');
...
$responseUserWallet = curl_call('https://api.coinpara.com/v1/userwallet?Symbol=BTC',$YourAPIKey,$YourAPISecret);
